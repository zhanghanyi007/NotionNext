...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '筱戶', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '市场的摆渡人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fishonly.eu.org', // 网站地址
